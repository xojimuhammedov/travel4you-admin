...
const BlogUpdateMain = ({ id }: idType) => {
  ...
  const onSubmit: SubmitHandler<FormData> = (data) => {
    ...
    axios
      ...
      .then((res) => {
        if (res.data.message === "Blog was updated successfully") {
          router.push("/blogs");
          toast.success(`Blog o'zgartirildi`, {
            position: "top-left",
          });
        }
      })
                ...
                <div className="cashier-select-field mb-5">
                  ...
                  <div className="cashier-input-field-style">
                    <div className="single-input-field w-full">
                      <input
                        type="text"
                        defaultValue={myproduct.link}
                        placeholder="blog youtube linki"
                        {...register("link")}
                      />
