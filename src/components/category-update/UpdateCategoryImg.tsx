...
const UpdateCategoryImg = ({ myproduct, closeModal, setchangeImage }: any) => {
  ...
  const updateInfo = {
    id: myproduct._id,
    categoryThumb: imgUpload,
  };
  const handleUpdate = () => {
    axios
      .put(`${process.env.BASE_URL}/setting/category-image?email=${user?.email}`, updateInfo,header)
      .then((res) => {
...
export default UpdateCategoryImg;
